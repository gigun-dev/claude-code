...
# =============================================================================
# 【何を検証するか / なぜこの3本なのか】
#   (1) JSON パースの回帰テスト: server.py --selftest-parse。**agy を1度も呼ばない**。
...
#   uv の起動)。(1) と (3) は agy を呼ばないので即座に終わる。
# =============================================================================
...
echo "=== [1/3] JSON パース回帰テスト (agy を呼ばない) ==="
...
echo ""
echo "=== [2/3] 正常系 + 会話継続: --selftest-followup ==="
echo "    query   : $query"
...
echo ""
echo "=== [3/3] 異常系: agy が PATH に無いとき fail-closed するか ==="
